...
<body class="body-index">
    ...
    <header class="bg-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="div-header">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".4s">¡Bienvenido al estilo de vida <b>XOCE®</b>!</p>
                        <a class="btn" href="registrarte-movil.php" role="button">Registrarte</a>
            ...
            <div class="row">
                <div id="divbtndown" class="col wow fadeInDown" data-wow-delay=".8s" data-wow-iteration="infinite"
                    data-wow-offset="10">

                    <center>

                        <a id="downrow" href="iniciosCliente-movil.php#conocenos"><i
    ...
    <section id="conocenos" class="sec-conocenos">
        <div class="container">
            <div class="row">
                <div class="col-md-6 div-conocenos">
                    <hr class="hr-index wow fadeInLeft" data-wow-delay=".2s">
                    <p class="p-title-sec wow fadeInUp" data-wow-delay=".4s">Conócenos</p>
                    <p class="p-info-conocenos">El reto XOCE® es el mejor Sistema de Nutricion Esencial, elaborado con
                        ingredientes prémium que te ayudan a lograr tus metas; con miles de testimonios que lo
                        confirman.</p>
                </div>
                ...
                <div class="col-md-3 col-6">
                    <div class="div-item-pro">
                        <div class="div-img-item-pro">
                            <img class="img-item-pro" src="../productos_img/<?= $producto['foto'] ?>" alt=""
                        ...
                        <div class="div-info-item-pro">
                            ...
                            <?php
                                    if (isset($producto['descuento'])) {
                                        ...
                                        ?>
                            <p class="precio-item-pro discount">$<?php echo $producto['precio']; ?></p>
                            <span><?php
    ...
    <section id="afiliate" class="sec-afiliate">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <p class="p-afiliate wow fadeInLeft" data-wow-delay=".2s">Afiliate</p>
                    <p class="p-sub-afiliate wow fadeInUp" data-wow-delay=".4s">Únete a la familia XOCE® y comienza a
                        ganar <b>¡HOY!</b></p>
                    <a class="btn btn-call-afiliate" href="tel:3311542899" role="button"><i style="margin-right: 6px;"
                            class="fas fa-phone-volume"></i> Llamar</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 div-contact-left">
                    <hr class="hr-index wow fadeInLeft" data-wow-delay=".2s">
                    <p class="p-title-sec wow fadeInUp" data-wow-delay=".2s">Contacto</p>
                    <p class="p-sub-sec">¡Quieres más información? ¡Escribenos!</p>

                    <form id="form-contact-data" class="form-contact">
                        <div class="form-group">
                            <input type="text" class="form-control input-contact" id="name-footer" name="nombre" placeholder="Nombre"
                                required>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input type="email" class="form-control input-contact" id="mail-footer"
                                    aria-describedby="emailHelp" placeholder="Correo" name="correo" required>
                            </div>

                            <div class="form-group col-md-6">
                                <input type="tel" class="form-control input-contact" id="phone-footer"
                        ...
                        <div class="form-group">
                            <textarea class="form-control input-message" id="message-footer" placeholder="Mensaje"
                                rows="3" name="mensaje"></textarea>
                        </div>

                        <button type="submit" class="btn btn-contact-footer"><i style="margin-right: 6px;"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="div-tel-footer">
                        ...
                        <br>
                        <p class="p-title-footer wow fadeInUp" data-wow-delay=".4s">Teléfonos</p>

                        <div class="footer-tels">
                            <a href="tel:018001230357">01 800 123 0357<i style="margin-left: 30px"
                                    class="fas fa-phone-volume"></i></a><br><br><a href="tel:+523322692108">(+52) 33
                                2269 2108<i style="margin-left: 30px" class="fas fa-phone-volume"></i> </a>
                        </div>
