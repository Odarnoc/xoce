...
<body>
    ...
    <div class="container">
        <div class="form-row row-btns-checkout">
            <div class="form-group col-md-12 col-12">
                <a class="btn btn-continuar-checkout" href="inicio.php" role="button">Método
                    de envío <i class="fas fa-chevron-right"></i></a>
            </div>
        </div>
    </div>
    ...
    <script src="./assets/js/generar-envio.js"></script>
