        ...
        <div class="container sec">
            <div class="row">
                ...
                <div style="padding-top: 0px;" class="col-md-6 col-12 card-box-cli-right">
                    <p class="p-orden">Total pagado: <b class="num-order">$<?php echo $TotalDetalle; ?></b></p>
                    <p class="p-cliente-checkout">Cliente: <b
                            ...
                            <?php echo $datosVentaYCliente['municipio'] . ', ' . $datosVentaYCliente['estado']; ?> </b>
                        <b class="cliente-phone"><i class="fas fa-mobile-alt"></i>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="td-img-review">
                                            <img class="img-table-review" src="productos_img/<?= $key['foto'] ?>"
                                                alt="">
                                        </td>
