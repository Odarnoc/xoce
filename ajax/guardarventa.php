...
header('Location: ../index.php');
	...
	$result = $FuncionesOpenpay->pagarTarjetaCliente($data["total"], $descripcionPago, $data['token'], $data['sessionId'], $data['moneda'], $data['customerId']);
	$objetoJson = json_decode($result);

	if($objetoJson->status != 400){
