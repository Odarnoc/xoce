...
class Chat
{
	...
	private $user  = 'u716723575_xoce';
	private $password   = "Ironmaiden1";
	private $database  = "u716723575_xoce";
	private $chatTable = 'chat';
	private $chatUsersTable = 'clientes';
	...
	{
		$sqlQuery = "
			SELECT u.id,u.current_session,u.online,u.avatar, CONCAT(u.nombre,' ',u.apellido) as user FROM " . $this->chatUsersTable . " as u
			WHERE u.id != '$userid'";
